...
export function CommunityDetail({ community }: CommunityDetailProps) {
          ...
          {community.members && (
            <div className="bg-white rounded-xl p-6 border border-neutral-200">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="text-xl font-bold text-neutral-900">Members</h4>
              </div>
          ...
          {community.type && (
            <div className="bg-white rounded-xl p-6 border border-neutral-200">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="text-xl font-bold text-neutral-900">Type</h4>
              </div>
              <p className="text-3xl font-black text-[var(--color-sage)] ml-12">
                {community.type}
              </p>
  ...
  const galleryContent = (
    <div className="bg-white rounded-xl p-8 border border-neutral-200">
      ...
      <p className="text-neutral-600">
        Photo gallery of {community.name} coming soon.
      </p>
    </div>
  );
